...
$string['selectsubject'] = 'Selecciona a materia';
$string['selectcourseband'] = 'Selecciona curso / ámbito';
$string['rubriccriteriamapping'] = 'Mapeo de criterios de rúbrica';
$string['mappingssaved'] = 'Mapeos de criterios curriculares gardados.';
$string['mappings_saved'] = 'Mapeos de criterios curriculares gardados.';
$string['selectcriteria'] = 'Criterios curriculares';
$string['rubricdimension'] = 'Dimensión da rúbrica';
$string['norubricavailable'] = 'Non hai actividades cunha rúbrica nativa de Moodle dispoñibles neste curso.';
$string['selectactivitywithrubric'] = 'Selecciona unha actividade con rúbrica';
...
$string['achievement_5_levels'] = 'Logro — 5 niveis';
