...
$string['detectedfamily'] = 'Detected stage: {$a}';
$string['usecurriculum'] = 'Use this curriculum';
$string['selectsubject'] = 'Select subject';
$string['selectcourseband'] = 'Select course / band';
$string['rubriccriteriamapping'] = 'Rubric criteria mapping';
$string['mappingssaved'] = 'Curriculum criteria mappings saved.';
$string['mappings_saved'] = 'Curriculum criteria mappings saved.';
$string['selectcriteria'] = 'Curriculum criteria';
$string['rubricdimension'] = 'Rubric dimension';
$string['norubricavailable'] = 'No activities with a native Moodle rubric are available in this course.';
$string['selectactivitywithrubric'] = 'Select an activity with a rubric';
$string['rubricmappingfor'] = 'Rubric mapping: {$a}';
$string['activitywithrubrics'] = 'Activities with native rubrics';
$string['valuation'] = 'Valuation';
$string['achievement_5_levels'] = 'Achievement — 5 levels';
$string['numeric_0_to_10'] = 'Numeric — 0 to 10';
$string['existing_moodle_scale'] = 'Use an existing Moodle scale (advanced)';
$string['continue'] = 'Continue';
$string['selected_count'] = 'Selected';
$string['criterios'] = 'Criteria';
$string['import_all'] = 'Select all';
$string['deselect_all'] = 'Deselect all';
$string['import_selected'] = 'Import selected';
