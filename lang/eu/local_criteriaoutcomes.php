...
$string['pluginname'] = 'Curriculum-emaitzak';
...
$string['importstep'] = '4 urratsetatik {$a->current}.a — {$a->label}';
$string['importstepsource'] = 'Iturri ofiziala';
$string['importstepcurriculum'] = 'Curriculuma';
$string['importstepvaluation'] = 'Balorazioa';
$string['importstepreview'] = 'Berrikusi eta berretsi';
$string['backandmodifysource'] = 'Atzera eta iturria aldatu';
$string['backandmodifygroup'] = 'Atzera eta titulua edo tartea aldatu';
$string['backandmodifycurriculum'] = 'Atzera eta curriculuma aldatu';
$string['backandmodifyvaluation'] = 'Atzera eta balorazioa aldatu';
$string['choosevaluation'] = 'Nola baloratuko dira emaitza hauek?';
$string['valuationhelp'] = 'Aukeratu eredu pedagogikoa. Gomendatutako eskala automatikoki sortzen edo berrerabiltzen da.';
$string['valuationachievement'] = 'Lorpena — 5 maila';
$string['valuationnumeric'] = 'Zenbakizkoa — 0tik 10era';
$string['valuationexisting'] = 'Erabili Moodleko eskala bat (aurreratua)';
$string['existingadvanced'] = 'Lehendik dagoen eskala';
$string['selectedcriteriacount'] = '{$a} irizpide hautatuta';
$string['selectall'] = 'Hautatu denak';
$string['deselectall'] = 'Desautatu denak';
$string['importselectedcriteria'] = 'Inportatu {$a} irizpide';
$string['selectcurriculumfp'] = 'Hautatu titulua eta lanbide-modulua';
$string['selectcurriculumgeneral'] = 'Hautatu ikasturte-tartea eta irakasgaia';
...
$string['mappingweight'] = 'Galderaren ekarpen-pisua';
$string['mappingweight_help'] = 'Pisu honek galderak galdetegi-saioko irizpideari nola laguntzen dion kontrolatzen du. Ez du irizpidearen curriculum-pisua aldatzen.';
$string['aggregations'] = 'Mapatutako galderak konbinatu';
$string['aggregations_help'] = 'Nola konbinatu behar dira irizpide berera mapatutako galderak galdetegi-saioko? Honek ez du ikaslearen irizpideko lorpen orokorra kalkulatzen.';
$string['aggregationshelp'] = 'Aukeratu irizpide berera mapatutako bi galdera edo gehiago nola konbinatu saioko. Galdetegiaren ebidentzia da, ez irizpideko lorpen orokorra.';
...
$string['managecurriculum'] = 'Curriculuma kudeatu';
...
$string['boeimport'] = 'BOEko curriculum ofiziala inportatu';
...
$string['existingscales'] = 'Dauden Moodle eskalak';
$string['recommendedscales'] = 'Curriculum-emaitzetarako gomendatutako eskalak';
$string['createscaletemplate'] = 'Sortu ikastaro honetarako';
$string['scaletemplatenumericname'] = 'Curriculum-emaitzak — 0–10';
$string['scaletemplateachievementname'] = 'Curriculum-emaitzak — Lorpena (5 maila)';
$string['scaletemplatecreated'] = 'Ikastarorako gomendatutako eskala prest dago.';
$string['scaletemplatehelp'] = 'Eskala ordinal honek curriculum-irizpideak baloratzen ditu. Ez ditu automatikoki aldatzen jardueren kalifikazioak, ikastaroaren kalifikazioa edo kalifikazio-liburuaren agregazioa.';
$string['errorscaletemplateconflict'] = 'Pluginaren eskala ez dator bat jada bere txantiloiarekin eta ez da aldatu.';
$string['scalelevelinsufficient'] = 'Ez nahikoa';
$string['scalelevelsufficient'] = 'Nahikoa';
$string['scalelevelgood'] = 'Ongi';
$string['scalelevelverygood'] = 'Oso ongi';
$string['scalelevelexcellent'] = 'Bikain';
$string['importfromjson'] = 'JSONetik inportatu';
$string['jsonimport'] = 'Curriculuma JSONetik inportatu';
$string['qualification'] = 'LHko titulua';
$string['qualificationunknown'] = 'Iturburuan identifikatu gabeko titulua';
$string['courseband'] = 'Ikasturtea edo tartea';
$string['coursebandunknown'] = 'Ikasturte guztiak';
$string['createsandselectscale'] = 'Sortu eta hautatu';
$string['scaleavailabletemplate'] = 'Txantiloi erabilgarria';
$string['scaleavailablecourse'] = 'Ikastaro honetan erabilgarri';
$string['importcurriculum'] = 'Curriculuma inportatu';
$string['assessmentmappings'] = 'Ebaluazioa eta mapaketak';
$string['currentcurriculum'] = 'Uneko curriculuma';
$string['detectedfamily'] = 'Etapa detektatua: {$a}';
$string['usecurriculum'] = 'Erabili curriculum hau';
$string['selectsubject'] = 'Hautatu gaia';
$string['selectcourseband'] = 'Hautatu maila / tartea';
$string['rubriccriteriamapping'] = 'Errubrika irizpideen mapaketa';
$string['mappingssaved'] = 'Curriculum irizpideen mapaketak gorde dira.';
$string['mappings_saved'] = 'Curriculum irizpideen mapaketak gorde dira.';
$string['selectcriteria'] = 'Curriculum irizpideak';
$string['rubricdimension'] = 'Errubrika dimentsioa';
$string['norubricavailable'] = 'Ez dago Moodle errubrika natibodun jarduerarik eskuragarri ikastaro honetan.';
$string['selectactivitywithrubric'] = 'Hautatu errubrikadun jarduera bat';
$string['rubricmappingfor'] = 'Errubrika mapaketa: {$a}';
$string['activitywithrubrics'] = 'Errubrika natibodun jarduerak';
$string['valuation'] = 'Balorazioa';
$string['achievement_5_levels'] = 'Lorpena — 5 maila';
$string['numeric_0_to_10'] = 'Zenbakizkoa — 0tik 10era';
$string['existing_moodle_scale'] = 'Erabili lehendik dagoen Moodle eskala (aurreratua)';
$string['continue'] = 'Jarraitu';
$string['selected_count'] = 'Hautatutakoak';
$string['criterios'] = 'Irizpideak';
$string['import_all'] = 'Hautatu guztiak';
$string['deselect_all'] = 'Desautatu guztiak';
$string['import_selected'] = 'Inportatu hautatutakoak';
